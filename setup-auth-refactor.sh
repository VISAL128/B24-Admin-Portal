...
echo "🔐 OIDC Callback URL: http://localhost:3000/get-started"
echo "❌ Error Page: http://localhost:3000/auth-error"
echo ""
...
echo "   - Valid Redirect URIs: http://localhost:3000/get-started"
...
echo "- Logout: http://localhost:3000/logout"
echo "- Callback: http://localhost:3000/get-started"
echo "- Error page: http://localhost:3000/auth-error"
echo ""
