...
export default defineEventHandler(async (_event): Promise<PgwModuleProfile | null> => {
  // return {
  //   code: '404',
  //   message: 'ERROR',
  //   message_kh: 'កំហុស',
  ...
  const response = (await requestToPgwModuleApi(
    ...
    '/current',
    'GET'
  )) as PgwModuleResponse<PgwModuleProfile | null>
  ...
  return response.data as PgwModuleProfile
})
