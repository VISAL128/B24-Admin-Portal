    ...
    <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4">
      <div class="flex items-center gap-3">
        ...
        <div :class="[
          ...
          getTransactionTypeIconStyle(transaction.transaction_type)
        ]">
          <UIcon 
            :name="getTransactionTypeIcon(transaction.transaction_type)" 
            class="w-5 h-5"
            :class="getTransactionTypeIconColor(transaction.transaction_type)"
            :title="getTransactionTypeDescription(transaction.transaction_type)"
          />
        </div>
