...
export const useNotification = () => {
  ...
  const showServerError = (statusCode?: number, customMessage?: string) => {
    ...
    let description =
      customMessage ||
      t('error.internal_server_error', 'An internal server error occurred. Please try again later.')
      ...
      switch (statusCode) {
        case 500:
          ...
          description =
            customMessage ||
            t(
              'error.internal_server_error_desc',
        ...
        case 503:
          ...
          description =
            customMessage ||
            t(
              'error.service_unavailable_desc',
        ...
        case 504:
          ...
          description =
            customMessage || t('error.gateway_timeout_desc', 'The server took too long to respond.')
          break
        default:
